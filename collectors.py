...
def attack(s, u_id, times):
    ...
    while True:
        try:
            response = s.post(url, data = attack_data, timeout = 1)
            if response.status_code == 200:
                break
            else:
                switch_proxy(s)
...
email0 = email0[:96]
email1 = email1[:32]
email2 = ['atahrali670@gmail.com','gitangli75757565@gmail.com','azharghaffar711@gmail.com','khanazamatullah68@gmail.com','nasem85736363@gmail.com','daan75646353@gmail.com','erica7267565@gmail.com','zaman75646@gmail.com','ayatullahali800@gmail.com','waqr85746364@gmail.com','error85645465@gmail.com','anushka885736343@gmail.com','hklurwsgscnms@gmail.com','xerfcvtybnikkg2@gmail.com', 'pknnjiutthfdsvz736@gmail.com', 'ljfdaazcbmouts904@gmail.com']
email3 = ['plnbcxzkgfsiyre233@gmail.com','pknbjiutfhfdrexc@gmail.com','eqsfxvnhlitec@gmail.com','kgdaqruoxbnj@gmail.com','eqsdcnmjlourfj905@gmail.com','ewdxvngklyrscb2@gmail.com','gkloyrqafscbm@gmail.com','wqadzvngkoitexv280@gmail.com']
email4 = ['hkloytewwsxvb6@gmail.com','wqsxvngkputexv@gmail.com','gdsaqruolhzcnm@gmail.com','bczagjloyeqcnax55@gmail.com']
email5 = ['wasifgf8@gmail.com','gujdianastewart@gmail.com']
email6 = ['ashfaq756474626@gmail.com']

passw = '1234512345'


'''emails = email0 + email1 + email2 + email3+ email4 + email5 + email6
for email in emails:
    try:
        ses, r = login(email, passw)
        train_data = {"ability_soldiers_atk": 'למד אותם שימוש באבנים'}
        postP(ses, 'http://s1.izra.co.il/training/upgradeability/', train_data)
    except:
        print(email)
        input('error')
input('d')

    #buy_data = {'a[1]': 1, 'buy': 'קנה', 'a[2]': '', 'a[3]': '', 'a[4]': '', 'a[5]': '', 'a[6]': '', 'a[7]': '', 'a[8]': '', 'a[9]': '', 'a[10]': '', 'a[11]': '', 'a[12]': '', 'a[13]': '', 'a[14]': '', 'a[15]': '', 'a[16]': ''}
    #postP(ses, 'http://s1.izra.co.il/shop', buy_data)
#print('f')'''
